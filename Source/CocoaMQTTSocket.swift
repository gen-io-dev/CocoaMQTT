...
public protocol CocoaMQTTSocketDelegate: AnyObject {
    ...
    func socketUrlSession(_ socket: CocoaMQTTSocketProtocol, didReceiveChallenge challenge: URLAuthenticationChallenge, completionHandler: @escaping (URLSession.AuthChallengeDisposition, URLCredential?) -> Void)
